...
from src.exchange import (
    fetch_ticker_price, fetch_klines, fetch_trade_details, handle_ban_error, check_rate_limit
)
import logging
...
def test_fetch_trade_details_success(mock_bitvavo):
    ...
    trade_count, largest_volume = fetch_trade_details("BTC/EUR", datetime(2021, 6, 30), datetime(2021, 7, 1))
